...
class DbConnection {
    ...
    // queries statements
    private let insertQueryString = "INSERT OR IGNORE INTO Whales (id, jsonString) VALUES (?,?)"
    ...
    public func openDatabase(){
        ...
        // creates db table
        if sqlite3_exec(db, "CREATE TABLE IF NOT EXISTS Whales (id TEXT PRIMARY KEY, jsonString TEXT)", nil, nil, nil) != SQLITE_OK {
